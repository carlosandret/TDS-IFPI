...
def main():
    print("Digite sua data de nascimento (no formato ddmmaaaa (um número inteiro com 8 dígitos)")
    data_nasc = int(input("--> "))
    num_sorte = soma_digito(data_nasc)
    print(f"Se você nasceu em {data_nasc}, o seu número da sorte é {num_sorte}!!!")
