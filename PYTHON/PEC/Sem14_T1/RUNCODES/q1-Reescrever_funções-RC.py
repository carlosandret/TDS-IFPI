...
def main():
    ...
    print(f"{func_len(lista_valores)}")
    print(f"{func_reverse(lista_valores)}")
    print(f"{func_min(lista_valores)}")
    print(func_max(lista_valores))
    print(func_sum(lista_valores))
