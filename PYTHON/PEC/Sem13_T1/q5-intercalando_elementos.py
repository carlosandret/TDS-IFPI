...
def main():
    ...
    lista_b = []
    print("Digite mais 25 números inteiros:")
    for i in range(25):
        elemento2 = int(input(""))
    ...
    for x, y in zip(lista_a, lista_b):
        lista_c.append(x)
        lista_c.append(y)
    print(f"A primeira lista e números é {lista_a}")
    print(f"A segunda lista e números é {lista_b}")
    print(f"Os números das duas listas intercalados é {lista_c}")
