...
def main():
    ...
    # Maria tenta se divorciar novamente
    maria.divorciar(joao)
    ...
    # Clara tenta se casar com João depois de morta
    clara.casar(joao)
    print(clara)
    
    # João tenta ter um filho com Clara depois de morta
