...
# maior soma de qualquer seguimento da lista. Ex: Ex: [5, -2, -2, -7, 3, 15, 10, -3, 9, -6, 4, 1] = 34
...
# Função que recebe uma lista e retorna a maior soma de qualquer segmento da lista
